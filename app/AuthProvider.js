...
class AuthProvider {
    ...
    async getTokenSilent(tokenRequest) {
        try {
            ...
            if (error instanceof InteractionRequiredAuthError) {
                ...
                return await this.getTokenIntaractive(tokenRequest)
            }
    ...
    async getTokenInteractive(tokenRequest) {
        try {
            ...
            const authResponse = await this.clientApplication.acquireTokenInteractive({
                ...
                errorTemplete: "<h1>Oops! Something went wrong</h1> <p>Check the console for more information.</p>",
            })
    ...
    async getAccount() {
        ...
        if (!currentAccounts) {
            console.log("No acccounts detected")
            return null
        }
