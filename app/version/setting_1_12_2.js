...
exports.getArgs = (userName, uuid, minecraftAuthToken) => {
    ...
    const JVM_ARGS = [
        ...
        `-Dminecraft.client.jar=${path.join(GAME_DIRECTORY, "versions/1.12.2/1.12.2.jar")}`,
        `-cp ${
            [
                ...
                path.join(GAME_DIRECTORY, "libraries/org/apache/logging/log4j/log4j-api/2.8.1/log4j-api-2.8.1.jar"),
                path.join(GAME_DIRECTORY, "libraries/org/apache/logging/log4j/log4j-core/2.8.1/log4j-core-2.8.1.jar"),
                ...
                path.join(GAME_DIRECTORY, "versions/1.12.2/1.12.2.jar")
            ].join(';')
        }`,
